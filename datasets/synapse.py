...
# TODO recommend install numpy==1.23.2, if you receive and error: ImportError: cannot import name 'QhullError' from 'scipy.spatial'
...
#
#     db_train = Synapse_dataset(base_dir='E:/Synapse/Synapse/train_npz', list_dir='../lists/lists_Synapse', split="train", img_size=224,
#                                norm_x_transform=x_transforms, norm_y_transform=y_transforms)
#
#     print(len(db_train))  # 2211
#
#     trainloader = DataLoader(db_train, batch_size=2, shuffle=True, num_workers=0,
#                              pin_memory=True, drop_last=True)
#     # print(len(trainloader)) # 1105
#
